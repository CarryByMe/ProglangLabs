...
### Задание 4
Создание объектных файлов по отдельности -o - параметр, позволяющий указать имя исполняемого файла с
программой. -c - создать объектные файлы для указанных единиц трансляции.
![](screens/04/01.png)
Сборка в исполняемый файл и его запуск
![](screens/04/02.png)
Если в файле синтаксическая ошибка, то мы не сможем собрать его в объктный файл. Поэтому мы сможем выполнить компиляцию, но если изначально в файле ошибка, то мы также не сможем создать .o и соответсвенно не сможем собрать, ведь у нас не будет хватать файла для сборки
![](screens/04/03.png)
Если один из файлов бдует потерян, то мы получим ошибку сборки
![](screens/04/04.png)

### Задание 5
Трансялиция в байткод и запуск программы
![](screens/05/01.png)
...
![](screens/08/6.png)
### Задание 8
* Оптимизация 0 - код переводмися в асембллер нарямую, повторяя цикл и суммирование
* Оптимизация 1 - Пустой цикл и уможение
